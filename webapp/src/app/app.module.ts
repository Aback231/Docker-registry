...
import { SystemContainersCardComponent } from './docker-container-system/system-containers-card/system-containers-card.component';
...
@NgModule({
  declarations: [
    ...
    SystemContainers,
    SystemContainersDetailComponent,
    NotFoundComponent,
    ServerErrorComponent,
    MemberCardComponent,
    SystemContainersCardComponent,
  ],
  imports: [
    BrowserModule,
    AppRoutingModule,
